...
var win=$(window);arr=[]
page_num=1
$.ajax({type:"GET",url:"/"+lang+"/upperlayer/available-providers-list",data:{page_num:page_num},contentType:"application/json; charset=utf-8",dataType:"json",success:function(result){var jposts=result;var dataTab=$.parseJSON(JSON.stringify(jposts));var arr=[];$('#max_page').val(dataTab.max_page)
$.each(dataTab.providers,function(index,value){if(value.image){image=value.image}
else{image='/media/pictures/None/no-image.png/'}
if(value.invite==true){$("#comapny-staff").append('<ul id="sortable"><li class="ui-sortable-handle"  data-provider-id='+value.id+' >\
                        ...
                        </ul>')}else{$("#comapny-staff").append('<ul id="sortable"><li class="ui-sortable-handle"  data-provider-id='+value.id+' >\
                        <div class="questionsection contact-routine-task">\
                        <div class="col-md-1 col-sm-2 col-xs-12 pd-none">\
                        <a class="fancybox"  href="{{ image.picture.url }}"><img class="img-responsive img-circle" src='+image+'></a>\
                        </div><div class="col-md-8 col-sm-9 col-xs-8"><div class="first-head"><h4 class="contact-name"><strong>Contact Name : </strong>'+value.name+'</h4><span><strong>Contact Type : </strong>'+value.contact_type+'</span></div>\
...
if(value.invite==false){$("#comapny-staff").append('<ul id="sortable"><li class="ui-sortable-handle"  data-provider-id='+value.id+' >\
                                <div class="questionsection contact-routine-task">\
                                <div class="col-md-1 col-sm-2 col-xs-12 pd-none">\
                                <a class="fancybox"  href="{{ image.picture.url }}"><img class="img-responsive img-circle" src='+image+'></a>\
                                </div><div class="col-md-8 col-sm-9 col-xs-8"><div class="first-head"><h4 class="contact-name"><strong>Contact Name : </strong>'+value.name+'</h4><span><strong>Contact Type : </strong>'+value.contact_type+'</span></div>\
                                ...
                                <div class="seond-head"><label><strong>Address : </strong>'+value.address+'</label><label class="staff_email"><strong>Email : </strong>'+value.email+'</label></div></div><div class="invite_massage"><a href="javascript:void(0);" data-id='+value.id+'\
                                class="col-sm-1 resume-btn btn default btn-xs green"><i class=""></i>invite</a></div><div class="see-resume"><a href="/en/upperlayer/display-resume/'+value.id+'/" class="btn default btn-xs green">See Resume</a></div>\<div class="clearfix"></div></div><hr></li>\
                                </ul>')}});},error:function(){},});$("#page_num").attr('value',page_num+1);}});});$(document).on("click",".invite_massage",function(){inv=$(this)
...
inv.parent().find('div.see-resume').css('display','none')}},error:function(){},});});$("#mySearch").on("keyup",function(){if($(this).val()==''){$("#comapny-staff").text("")
var win=$(window);arr=[]
page_num=1
$.ajax({type:"GET",url:"/"+lang+"/upperlayer/available-providers-list",data:{page_num:page_num},contentType:"application/json; charset=utf-8",dataType:"json",success:function(result){var jposts=result;var dataTab=$.parseJSON(JSON.stringify(jposts));var arr=[];$('#max_page').val(dataTab.max_page)
$.each(dataTab.providers,function(index,value){if(value.image){image=value.image}
...
if($(this).val().length>=3){$.ajax({type:"GET",url:"/"+lang+"/upperlayer/provider-available-for-add",data:{'search_value':$('#mySearch').val()},contentType:"application/json; charset=utf-8",dataType:"json",success:function(result){if(result.status==404){$("#comapny-staff").text("No provider found")}
else{$("#comapny-staff").text("")
var jposts=result;var dataTab=$.parseJSON(JSON.stringify(jposts));$.each(dataTab.providers,function(index,value){if(value.image){image=value.image}
else{image='/media/pictures/None/no-image.png/'}
if(value.invite==false){$("#comapny-staff").append('<ul id="sortable"><li class="ui-sortable-handle"  data-provider-id='+value.id+' >\
                            <div class="questionsection contact-routine-task">\
                            <div class="col-md-1 col-sm-2 col-xs-12 pd-none">\
